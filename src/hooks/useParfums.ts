...
export const mapRowToParfum = (row: any): Parfum => {
  ...
  return {
    ...
    image_label_en: row.image_label_en || undefined,
    name_en: row.name_en || undefined,
    description_en: row.description_en || undefined,
    notes_en: row.notes_en || undefined,
    weight_value: row.weight_value || undefined,
    weight_unit: row.weight_unit || undefined,
    volume_value: row.volume_value || undefined,
    volume_unit: row.volume_unit || undefined,
...
export const mapLocalToParfum = (p: AdminParfum): Parfum => {
  ...
  return {
    ...
    notes_en: typeof p.notes_en === "string" ? p.notes_en : undefined,
    price_5ml: p.prices?.["5ml"] ?? 0,
    price_10ml: p.prices?.["10ml"] ?? 0,
    image_label: p.imageLabel,
    image_label_en: p.image_label_en || undefined,
