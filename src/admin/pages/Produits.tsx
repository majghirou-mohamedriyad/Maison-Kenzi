...
const CATEGORY_TITLES: Record<string, { title: string; subtitle: string; icon: any; addButtonText: string; categorySlug: string }> = {
  ...
  "bazar-chic": {
    title: "Bazar Chic & Décoration",
    subtitle: "Trouvailles raffinées, accessoires tendance & art de vivre",
    icon: Sparkles,
    addButtonText: "Nouveau Produit Bazar Chic",
    categorySlug: "bazar-chic",
  },
  bazar: {
    title: "Bazar Chic & Décoration",
    subtitle: "Trouvailles raffinées, accessoires tendance & art de vivre",
  ...
  antiques: {
    title: "Bazar Chic & Pièces Rares",
    subtitle: "Trouvailles raffinées, accessoires tendance & objets précieux",
    icon: Landmark,
    addButtonText: "Nouveau Produit Bazar Chic",
    categorySlug: "bazar-chic",
  },
