...
const SLIDES = [
  {
    ...
    subtitle: "Parfums de niche d'exception et décants rares sélectionnés pour les connaisseurs au Maroc.",
  ...
  {
    id: 2,
    tag: "CRÉATIONS DE NICHE & DÉCANTS",
    titlePrefix: "L'Art du ",
    titleHighlight: "Sillage",
    subtitle: "Explorez les plus grandes maisons olfactives en formats nomades 5ml & 10ml en verre noble.",
