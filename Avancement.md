...
- [x] Refonte Design Haute Parfumerie de l'Espace Admin & Sidebar Rétractable :
  ...
  - [x] [`src/admin/pages/Produits.tsx`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/admin/pages/Produits.tsx) & [`src/admin/components/ProductModal.tsx`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/admin/components/ProductModal.tsx) : Suppression définitive des sections « Mode de vente » et « Tarification & Stocks par Format » (décantage multi-formats). Intégration directe des champs **Prix de vente (MAD)**, **Volume / Contenance (ml)** et **Stock disponible** dans la section « Informations générales » pour la vente exclusive de parfums en flacons complets.
