...
- [x] Refonte Design Haute Parfumerie de l'Espace Admin & Sidebar Rétractable :
  ...
  - [x] [`src/admin/pages/Produits.tsx`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/admin/pages/Produits.tsx) & [`src/admin/components/ProductModal.tsx`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/admin/components/ProductModal.tsx) : Suppression des sections « Mode de vente », « Tarification & Stocks par Format » et « Pyramide Olfactive ». Intégration directe des champs **Prix de vente (MAD)**, **Volume / Contenance (ml)**, **Stock disponible** et **Notes olfactives** (séparées par une virgule) dans la section « Informations générales & Prix » pour une gestion fluide des parfums.
