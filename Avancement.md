...
- [x] Affichage Haute Parfumerie des Saisons d'Utilisation & Profil Olfactif :
  ...
  - [x] [`src/hooks/useAppSettings.ts`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/hooks/useAppSettings.ts) : Suppression de la souscription WebSocket realtime non exposée sur le VPS direct (`ws://.../realtime`), éliminant définitivement les erreurs et boucles de reconnexion dans la console du navigateur.
