...
- [x] Affichage Haute Parfumerie des Saisons d'Utilisation & Profil Olfactif :
  ...
  - [x] [`src/components/content/ProductCarousel.tsx`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/components/content/ProductCarousel.tsx) : Correction du doublon de devise « MAD MAD » sur les cartes de la page d'accueil.
  - [x] [`src/admin/lib/syncParfum.ts`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/admin/lib/syncParfum.ts) & [`src/hooks/useParfums.ts`](file:///c:/Users/PC/Desktop/Maison-Kenzi/src/hooks/useParfums.ts) : Synchronisation bidirectionnelle et persistance garantie des saisons d'utilisation entre l'espace admin et l'interface publique.
